...
const Maincomponent = () => {
  return (
    <>
      <main className=' '>
        <nav className="flex flex-wrap items-center justify-center sticky top-0 z-40 mb-10 backdrop-blur-lg  ">
          <div className="container mx-auto  lg:hidden flex flex-wrap items-center justify-center">
            <div className="w-full flex lg:w-auto  px-5 container  justify-around sm:justify-center items-center">
              <button className=''>
                <img src={MENU} alt="menu" className='invert' />
              </button>
              <a download href='../public/DayronGlezCV.pdf' className='flex   text-center items-center  '><p className=' transition-colors duration-500 text-xl text-[#2cb7ea] m-6  rounded-md hover:bg-[#2cb7ea] hover:text-white  '>Download CV</p></a>
            </div>
          </div>
          <div className='hidden lg:flex lg:flex-row lg:max-w-5xl lg:h-20'>
            <ul className="flex  flex-row items-center lg:w-screen justify-evenly">
              <li className='text-xl text-white hover:text-[#2cb7ea]'>About me</li>
              <li className='text-xl text-white hover:text-[#2cb7ea]'>Project</li>
              <li>
        ...
        <section className='mx-auto w-11/12 pl-5 pr-5 mt-12'>
          <h1 className='text-3xl text-[#2cb7ea]'>Relevant Projects</h1>
          
            <div className='flex flex-col mt-10 mb-10'>
              <img src={Faztgrab} alt="faztgrab project" className=' rounded-t-xl h-[250px]'/>
              <div className=' pl-8 pr-8 flex flex-col items-center bg-[#044151] rounded-b-xl'>
