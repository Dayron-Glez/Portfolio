...
const HeaderComponent = () => {
  ...
  return (
    <>
      <header ref={headerRef} className=' h-screen flex flex-col  items-center justify-center w-[100%] gap-14 lg:gap-16'>

        <div className='animate__animated myBackInUp animate__slow'>
        ...
        <div className='flex flex-col lg:flex-row gap-x-4  items-center animate__animated animate__backInDown animate__slow mb-20 lg:mb-20'>
          <h1 className=' text-cyan-100  text-[60px]    lg:text-[80px]'>Front-End</h1>
          <h1 className=' text-[#2cb7ea] text-[60px]  lg:text-[80px]'>Developer</h1>
        </div>
        {/* <a className='flex flex-col items-center animate-[animation] transition-all duration-2000'>
